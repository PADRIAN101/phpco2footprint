...
<section class="max-w-2xl mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    <form method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <select value="<?php echo e($oldFormData['category'] ?? ''); ?>" name="category" type="text"
        ...
        <label class="block">
            ...
            <input value="<?php echo e($oldFormData['emission'] ?? ''); ?>" name="emission" type="number" step="0.01" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
            <?php if (array_key_exists('emission', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500">
                    <?php echo e($errors['emission'][0]); ?>
                </div>
            <?php endif; ?>
        </label>
        <label class="block">
