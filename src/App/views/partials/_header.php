...
<head>
    ...
    <title> <?php echo e($title); ?> PHPCo2Footprint</title>
...
<body class="bg-indigo-50 font-['Outfit']">
    ...
    <header class="bg-green-900">
        <nav class="mx-auto flex container items-center justify-between py-4" aria-label="Global">
            <a href="/" class="-m-1.5 p-1.5 text-white text-2xl font-bold">PHPCo2Footprint</a>
            <!-- Navigation Links -->
            <div class="flex lg:gap-x-10">
                <a href="/about" class="text-gray-300 hover:text-white transition">About</a>
                <a href="/about" class="text-gray-300 hover:text-white transition">Dashboard</a>
